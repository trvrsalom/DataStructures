...
public class InheritanceLab_Salom {
...
class Student extends Person {
	...
	public void greet() {
		System.out.println(this + " says: " + getGreeting());
	};
}
...
class BellarmineStudent extends Student {
	...
	public String toString() {
		return "Bellarmine Student " + getName();
	}
}
...
class NotreDameStudent extends Student {
	...
	public String toString() {
		return "Notre Dame Student " + getName();
	}
}
...
class BellarmineTeacher extends Teacher {
	...
	public String toString() {
		return "Bellarmine Teacher " + getName();
	}
}
...
class NotreDameTeacher extends Teacher {
	...
	public String toString() {
		return "Notre Dame Teacher " + getName();
	}
}
